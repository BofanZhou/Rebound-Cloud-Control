...
# Callback type: machine_id, task_id, actual_angle, deviation, final_status
OnCompleteCallback = Callable[[str, str, float, float, str], None]
# Callback type: machine_id, new_state (called on any status change)
OnStateChangeCallback = Callable[[str, DeviceState], None]
...
class DeviceSimulator:
    ...
    def __init__(
        ...
        on_complete_callback: Optional[OnCompleteCallback] = None,
        on_state_change_callback: Optional[OnStateChangeCallback] = None,
    ):
    ...
    def _notify_state_change(self):
        ...
        if self._on_state_change_callback:
            try:
                self._on_state_change_callback(self.machine_id, self.state)
            except Exception:
                pass
